...
typedef struct BIOS_Parameter_Block_struct {
    ...
    uint8_t BPB_BytesPerSector[2];  // 512, 1024, 2048 or 4096
    uint8_t BPB_SectorPerCluster;     // 1, 2, 4, 8, 16, 32, 64 or 128
    uint8_t BPB_RsvdSectorCnt[2];  // 1 for FAT12 and FAT16, typically 32 for FAT32
    uint8_t BPB_NumFATs;        // should be 2
    uint8_t BPB_RootEntCnt[2];
    uint8_t BPB_TotSector16[2];
    uint8_t BPB_Media;
    uint8_t BPB_FATSz16[2];
    uint8_t BPB_SectorPerTrk[2];
    uint8_t BPB_NumHeads[2];
    uint8_t BPB_HiddSector[4];
    uint8_t BPB_TotSector32[4];
    uint8_t BPB_FATSz32[4];
    uint8_t BPB_ExtFlags[2];
    uint8_t BPB_FSVer[2];
    uint8_t BPB_RootCluster[4];
    uint8_t BPB_FSInfo[2];
    uint8_t BPB_BkBootSector[2];
...
typedef struct FAT_directory_entry_struct {
    ...
    uint8_t DIR_FstClusterHI[2];
    uint8_t DIR_WrtTime[2];
    uint8_t DIR_WrtDate[2];
    uint8_t DIR_FstClusterLO[2];
