[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/MkpwcJ9I)
TP4: FAT 32 
=============
...
La première fonction que vous aurez à implémenter est la suivante:
    ...
    uint32 cluster_to_logical_block_addr(uint32 cluster,
                          BPB *block,
...
### 2- Aller chercher le prochain maillon de la chaîne FAT 
    ...
    error_code get_cluster_chain_value(uint32 cluster,
                                       BPB *block,
                                       uint32 *value,
                                       FILE *archive);
...
### 4- Analyser un chemin 
    ...
    error_code split_up_path(uint8 level, char *path, char **output);
